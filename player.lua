...
function player.land()
    ...
    objects[1].worldNum = currentWorld
    objects[1].body:setY(currentWorldObjects[math.floor(#currentWorldObjects/2)].body:getY()-100) --Moves player to surface
    objects[1].body:setActive(true)
end
...
function player.update(dt)
    ...
    elseif love.keyboard.isDown("return") then --press the enter key to set in the air
        planets.changeWorld(math.random(1,20))
        player.land()
